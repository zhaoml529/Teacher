...
<meta charset="utf-8">
  ...
  <script type="text/javascript">
  	...
  	function doDel( id ){
  		window.location.href = "${ctx}/bookAction/doDelete/"+id;
  	}
    ...
    <div class="template-page-wrapper">
     ...
     <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
		  ...
		  <form:form action="${ctx }/bookAction/toList_page" id="pageForm" method="POST">
          ...
          <!-- Split button -->
			...
			<c:choose>
				...
				<c:otherwise>
					<button type="button" class="btn btn-success btn-sm" onclick="javascript:window.location.href='${ctx }/bookAction/toAdd'">添加</button>
				</c:otherwise>
			</c:choose>
			  ...
			  <ul class="dropdown-menu" role="menu">
			    <li><a href="${ctx }/bookAction/toList_page?orderBy=ASC">创建时间升序</a></li>
			    <li><a href="${ctx }/bookAction/toList_page?orderBy=DESC">创建时间降序</a></li>
			    <li class="divider"></li>
			    <li>
			    	<c:choose>
						<c:when test="${type != null }">
						<a href="${ctx }/bookAction/toList_page?type=${type }">刷新列表</a>
						</c:when>
						<c:otherwise>
							<a href="${ctx }/bookAction/toList_page">刷新列表</a>
						</c:otherwise>
					</c:choose>
			    </li>
			  </ul>
				    ...
				    <c:forEach items="${bookList }" var="book">
					  	<tr>
					  		...
					  		<td>
					  			...
					  			<button type="button" class="btn btn-danger btn-xs" onclick="doDel('${book.id}');">删除</button>
					  		</td>
					  	</tr>
					</c:forEach>
		  		</c:otherwise>
