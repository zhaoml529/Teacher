    ...
    <div class="template-page-wrapper">
     ...
     <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <form:form action="${ctx }/paperAction/doAdd" modelAttribute="paper" method="POST">
          <input type="hidden" name="teacher.teacherId" value="${user.teacherId }"/>
          <input type="hidden" name="type" value="${type }"/>
          <div class="table-responsive">
          	<table class="table table-bordered table-condensed">
		  	<tr class="active">
		  		<td colspan="2" align="center">添加论文信息</td>
		  	</tr>
		  	<tr>
		  		<td>论文名称</td>
		  		<td>
		  	...
		  	<tr>
		  		...
		  		<td>
					...
					<div id="publishDate" class="input-group date form_datetime">
