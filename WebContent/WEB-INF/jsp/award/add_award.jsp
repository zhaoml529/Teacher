    ...
    <div class="template-page-wrapper">
     ...
     <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <form:form action="${ctx }/awardAction/doAdd" modelAttribute="award" method="POST">
          ...
          <div class="table-responsive">
		  	...
		  	<tr>
		  		...
		  		<td>
			    	...
			    	<input type="text" name="name" value="${award.name }" class="form-control" placeholder="Enter name">
		  		</td>
		  	</tr>
		  	<tr>
		  		<td>获奖级别</td>
