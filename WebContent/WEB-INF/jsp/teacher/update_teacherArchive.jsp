	          ...
	          <table class="table table-bordered table-condensed">
			  	...
			  	<tr>
			  		...
			  		<td colspan="2" rowspan="7" align="center">
			  			<input type="hidden" id="pictureUrl" name="pictureUrl" value="${teacher.teacherPic }" />
			  			<div class="thumbnail">
			  	...
			  	<tr>
			  		...
			  		<td>
			  			...
			  			<select class="form-control" name="mandarinLevel">
			  				...
			  				<option ${teacher.mandarinLevel == '一级甲等'?'selected':'' } value="一级甲等">一级甲等</option>
			  				<option ${teacher.mandarinLevel == '一级乙等'?'selected':'' } value="一级乙等">一级乙等</option>
			  				<option ${teacher.mandarinLevel == '二级甲等'?'selected':'' } value="二级甲等">二级甲等</option>
			  				<option ${teacher.mandarinLevel == '二级乙等'?'selected':'' } value="二级乙等">二级乙等</option>
			  				<option ${teacher.mandarinLevel == '三级甲等'?'selected':'' } value="三级甲等">三级甲等</option>
			  				<option ${teacher.mandarinLevel == '三级乙等'?'selected':'' } value="三级乙等">三级乙等</option>
			  			</select>
			  		</td>
			  	</tr>
			  	<tr>
			  		...
			  		<td>
			  			...
			  			<select class="form-control" name="technicalPosition">
			  				<option value="0">--请选择--</option>
			  				<option ${teacher.technicalPosition == '教授'?'selected':'' } value="教授">教授</option>
			  				<option ${teacher.technicalPosition == '副教授'?'selected':'' } value="副教授">副教授</option>
			  				<option ${teacher.technicalPosition == '讲师'?'selected':'' } value="讲师">讲师</option>
			  				<option ${teacher.technicalPosition == '助理讲师'?'selected':'' } value="助理讲师">助理讲师</option>
			  			</select>
			  		</td>
			  	</tr>
			  	<tr>
